...
bool Thread::is_blocked(bool check_if_block_only) const {
    ...
    return !check_if_block_only && (_state == ThreadState::BLOCKED || _state == ThreadState::BLOCKED_AND_SLEEPING);
}
...
bool Thread::is_sleeping(bool check_if_sleeping_only) const {
    ...
    return !check_if_sleeping_only && (_state == ThreadState::SLEEPING || _state == ThreadState::BLOCKED_AND_SLEEPING);
}
